...
return [
    'error' => [
        ...
        'user' => [
            'authentication_feature_disabled' => 'User authentication is temporarily disabled.',
        ],
        'shortlink' => [
            'destination' => [
            ...
            'creation_feature_disabled' => 'Shortlink creation is temporarily disabled.',
            'redirection_feature_disabled' => 'Shortlink redirection is temporarily disabled.',
        ],
    ],
];
