	...
	<TabGroup>
		...
		<TabPanels>
			<TabPanel>
				...
				<p>All endpoints that return typical content responses support the following formats (via the <code>format</code> query string): json, xml, csv, php. Error responses will always be JSON.</p>
